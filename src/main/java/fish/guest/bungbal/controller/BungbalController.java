package fish.guest.bungbal.controller;

import fish.guest.bungbal.dto.BungbalRequest;
import fish.guest.bungbal.service.BungbalService;
...
@RequestMapping("/guest/bungbal/stats")
