package fish.user.community.post.service;
...
import fish.user.community.post.repository.PostReportRepository;
import fish.user.community.post.repository.PostRepository;
import fish.user.community.post.dto.response.PostDetailResponse;
import fish.user.community.post.dto.response.PostResponse;
import fish.user.community.vote.repository.VoteRepository;
