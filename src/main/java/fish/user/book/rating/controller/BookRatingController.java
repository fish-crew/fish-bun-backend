package fish.user.book.rating.controller;

import fish.user.book.rating.dto.request.BookRatingRequest;
import fish.user.book.rating.service.BookRatingService;
