...
public class FileUtils {
    ...
    public static BungDiaryFile fileUpload(MultipartFile multipartFile, String uploadFolder) throws IOException {
        ...
        return new BungDiaryFile(originFileName, systemFileName, filePath, multipartFile.getSize(), originFileExtension);
