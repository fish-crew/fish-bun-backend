package fish.member.community.vote.service;

import fish.member.community.vote.dto.VoteRequest;
import fish.domain.community.vote.Vote;
...
public class VoteService {
    ...
    public List<Map<String, Object>> saveVote(Long postId, VoteRequest request) {
        Optional<Vote> vote = voteRepository.findByPostIdAndUserId(postId, request.getUserId());
        ...
        voteRepository.save(Vote.toEntity(postId, request.getUserId(), request));
