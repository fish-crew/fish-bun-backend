package fish.member.community.comment.index.service;
...
import fish.domain.community.comment.index.Comment;
import fish.domain.community.comment.index.CommentRepository;
...
public class CommentService {
    ...
    public Long saveComment(Long postId, CommentRequest request, User user) {
        Comment entity = Comment.toEntity(postId, request, user);
